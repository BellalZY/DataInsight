...
dfs = {}
uploaded_files = ["visualization/data/DIM_CUSTOMER.csv","visualization/data/DIM_DATE.csv","visualization/data/DIM_ORDER.csv","visualization/data/DIM_PRODUCT.csv","visualization/data/DIM_RETURN.csv","visualization/data/sales_over_time.csv","visualization/data/sales_profit_subCategory.csv","visualization/data/monthly_sales_trend.csv","visualization/data/profitability_category.csv","visualization/data/top10_customer.csv","visualization/data/ship_performance.csv",]
...
df1 = pd.read_csv("visualization/data/DIM_CUSTOMER.csv")
df2 = pd.read_csv("visualization/data/DIM_DATE.csv")
df3 = pd.read_csv("visualization/data/DIM_ORDER.csv")
df4 = pd.read_csv("visualization/data/DIM_PRODUCT.csv")
df5 = pd.read_csv("visualization/data/DIM_RETURN.csv")
